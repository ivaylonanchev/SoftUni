...
namespace TravelAgency
{
    public class StartUp
    {
        ...
        private static void ExportEntities(TravelAgencyContext context, string exportDir)
        {
            ...
            Console.WriteLine(GuidesWithSpanishLanguageWithAllTheirTourPackages);
            File.WriteAllText
                (exportDir + "Actual Result - Export Guides With Spanish Language With All Their Tour Packages.xml", GuidesWithSpanishLanguageWithAllTheirTourPackages);
            ...
            Console.WriteLine
                (CustomersThatHaveBookedHorseRidingTourPackage);
            File.WriteAllText
                (exportDir + "Actual Result - Export Customers With Their Bookings.json", CustomersThatHaveBookedHorseRidingTourPackage);
        }
