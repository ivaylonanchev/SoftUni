...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=DESKTOP-FE75MLC\SQLEXPRESS;Database=Travel Agency;Integrated Security=True;Encrypt=False";
       ...
       public DbSet<TourPackageGuide> TourPackagesGuides { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TourPackageGuide>()
                .HasKey(x => new { x.GuideId, x.TourPackageId });
