...
namespace NetPay.Data
{
    ...
    {
        private const string connectionString = @"Server=DESKTOP-FE75MLC\SQLEXPRESS;Database=NetPay;Integrated Security=True;Encrypt=False";
        ...
        {
            modelBuilder.Entity<SupplierService>(sp => sp.HasKey(
                k => new { k.ServiceId, k.SupplierId }));
