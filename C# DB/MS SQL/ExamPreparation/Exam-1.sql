...
(
	...
	CONSTRAINT FK_HotelsRooms_HotelID FOREIGN KEY (HotelId) REFERENCES Hotels(Id), 
	CONSTRAINT FK_HotelsRooms_RoomId FOREIGN KEY (RoomId) REFERENCES Rooms(Id)
)
...
WHERE TouristId IN (SELECT Id FROM @ToDelete)
